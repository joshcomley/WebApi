...
namespace Microsoft.AspNet.OData.Query
{
    ...
    public class OrderBySingleValueFunctionNode : OrderByNode
    {
            ...
            : base(orderByClause)
        {
            ...
            {
                Parameters = propertyExpression.Parameters;
                FunctionName = propertyExpression.Name;
            }
        }

        /// <summary>
        /// The name of the function being ordered by.
        /// </summary>
        public string FunctionName { get; set; }

        /// <summary>
        /// The parameters of the function being ordered by.
        /// </summary>
